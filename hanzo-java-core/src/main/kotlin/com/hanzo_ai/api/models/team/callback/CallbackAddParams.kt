...
private constructor(
     ...
     */
    fun callbackType(): Optional<CallbackType> = body.callbackType()
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.callbackType] with `callbackType.orElse(null)`. */
        fun callbackType(callbackType: Optional<CallbackType>) =
            callbackType(callbackType.getOrNull())
    ...
    class CallbackType @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmField val SUCCESS_AND_FAILURE = of("success_and_failure")

            @JvmStatic fun of(value: String) = CallbackType(JsonField.of(value))
        }
