...
private constructor(
    ...
    fun regenerateKeyRequest(): Optional<RegenerateKeyRequest> =
        Optional.ofNullable(regenerateKeyRequest)
    ...
    class Builder internal constructor() {
        ...
        /**
         * Alias for calling [Builder.regenerateKeyRequest] with
         * `regenerateKeyRequest.orElse(null)`.
         */
        fun regenerateKeyRequest(regenerateKeyRequest: Optional<RegenerateKeyRequest>) =
            regenerateKeyRequest(regenerateKeyRequest.getOrNull())
