...
private constructor(
     ...
     */
    fun llmParams(): Optional<LlmParams> = llmParams.getOptional("llm_params")
    ...
    internal fun validity(): Int =
        (llmParams.asKnown().getOrNull()?.validity() ?: 0) +
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun llmTraceId(): Optional<String> = llmTraceId.getOptional("llm_trace_id")
         ...
         * ```java
         * MyClass myObject = llmParams.modelInfo().convert(MyClass.class);
         * ```
         */
        ...
        internal fun validity(): Int =
            (if (apiBase.asKnown().isPresent) 1 else 0) +
                ...
                (if (llmTraceId.asKnown().isPresent) 1 else 0) +
