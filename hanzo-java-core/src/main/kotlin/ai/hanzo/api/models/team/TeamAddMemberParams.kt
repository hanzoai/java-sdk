...
private constructor(
     ...
     */
    fun maxBudgetInTeam(): Optional<Double> = body.maxBudgetInTeam()
    ...
    private constructor(
        ...
        fun members(): Optional<List<Member>> = Optional.ofNullable(members)

        fun member(): Optional<Member> = Optional.ofNullable(member)
         ...
         *     @Override
         *     public Optional<String> visitMembers(List<Member> members) {
         *         return Optional.of(members.toString());
         *     }
         *
         *     // ...
         *
        ...
        companion object {
            ...
            @JvmStatic fun ofMember(member: Member) = Member(member = member)
        }
