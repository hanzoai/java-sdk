...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun modelAliases(): Optional<ModelAliases> = body.modelAliases()
     ...
     *   server responded with an unexpected value).
     */
    fun secretManagerSettings(): Optional<SecretManagerSettings> = body.secretManagerSettings()

    /**
     * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun tags(): Optional<List<JsonValue>> = body.tags()

    /**
     * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun teamAlias(): Optional<String> = body.teamAlias()

    /**
     * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun teamMemberBudget(): Optional<Double> = body.teamMemberBudget()

    /**
     * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun teamMemberBudgetDuration(): Optional<String> = body.teamMemberBudgetDuration()

    /**
     * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun teamMemberKeyDuration(): Optional<String> = body.teamMemberKeyDuration()

    /**
     * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun teamMemberRpmLimit(): Optional<Long> = body.teamMemberRpmLimit()

    /**
     * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun teamMemberTpmLimit(): Optional<Long> = body.teamMemberTpmLimit()
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.modelAliases] with `modelAliases.orElse(null)`. */
        fun modelAliases(modelAliases: Optional<ModelAliases>) =
            modelAliases(modelAliases.getOrNull())
        ...
        /**
         * Alias for calling [Builder.secretManagerSettings] with
         * `secretManagerSettings.orElse(null)`.
         */
        fun secretManagerSettings(secretManagerSettings: Optional<SecretManagerSettings>) =
            secretManagerSettings(secretManagerSettings.getOrNull())
        ...
        fun tags(tags: Optional<List<JsonValue>>) = tags(tags.getOrNull())
        ...
        /** Alias for calling [Builder.teamMemberBudget] with `teamMemberBudget.orElse(null)`. */
        fun teamMemberBudget(teamMemberBudget: Optional<Double>) =
            teamMemberBudget(teamMemberBudget.getOrNull())
        ...
        /**
         * Alias for calling [Builder.teamMemberBudgetDuration] with
         * `teamMemberBudgetDuration.orElse(null)`.
         */
        fun teamMemberBudgetDuration(teamMemberBudgetDuration: Optional<String>) =
            teamMemberBudgetDuration(teamMemberBudgetDuration.getOrNull())
        ...
        /**
         * Alias for calling [Builder.teamMemberKeyDuration] with
         * `teamMemberKeyDuration.orElse(null)`.
         */
        fun teamMemberKeyDuration(teamMemberKeyDuration: Optional<String>) =
            teamMemberKeyDuration(teamMemberKeyDuration.getOrNull())
        ...
        /**
         * Alias for calling [Builder.teamMemberRpmLimit] with `teamMemberRpmLimit.orElse(null)`.
         */
        ...
        /**
         * Alias for calling [Builder.teamMemberTpmLimit] with `teamMemberTpmLimit.orElse(null)`.
         */
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun secretManagerSettings(): Optional<SecretManagerSettings> =
            secretManagerSettings.getOptional("secret_manager_settings")
         ...
         *   server responded with an unexpected value).
         */
        fun teamMemberBudget(): Optional<Double> =
            teamMemberBudget.getOptional("team_member_budget")

        /**
         * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
        fun teamMemberBudgetDuration(): Optional<String> =
            teamMemberBudgetDuration.getOptional("team_member_budget_duration")

        /**
         * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
        fun teamMemberKeyDuration(): Optional<String> =
            teamMemberKeyDuration.getOptional("team_member_key_duration")
        ...
        fun validate(): Body = apply {
            ...
            modelAliases().ifPresent { it.validate() }
            ...
            rpmLimit()
            secretManagerSettings().ifPresent { it.validate() }
            tags()
            teamAlias()
            teamMemberBudget()
            teamMemberBudgetDuration()
        ...
        internal fun validity(): Int =
            (if (teamId.asKnown().isPresent) 1 else 0) +
                ...
                (secretManagerSettings.asKnown().getOrNull()?.validity() ?: 0) +
                (tags.asKnown().getOrNull()?.size ?: 0) +
                (if (teamAlias.asKnown().isPresent) 1 else 0) +
                (if (teamMemberBudget.asKnown().isPresent) 1 else 0) +
                (if (teamMemberBudgetDuration.asKnown().isPresent) 1 else 0) +
                (if (teamMemberKeyDuration.asKnown().isPresent) 1 else 0) +
