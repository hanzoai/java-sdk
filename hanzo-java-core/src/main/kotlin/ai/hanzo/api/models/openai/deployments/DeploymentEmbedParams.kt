...
private constructor(
     ...
     */
    fun apiBase(): Optional<String> = body.apiBase()
     ...
     *   server responded with an unexpected value).
     */
    fun apiType(): Optional<String> = body.apiType()

    /**
     * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun apiVersion(): Optional<String> = body.apiVersion()
     ...
     *   server responded with an unexpected value).
     */
    fun customLlmProvider(): Optional<CustomLlmProvider> = body.customLlmProvider()

    /**
     * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun input(): Optional<List<String>> = body.input()

    /**
     * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun litellmCallId(): Optional<String> = body.litellmCallId()

    /**
     * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun litellmLoggingObj(): Optional<LitellmLoggingObj> = body.litellmLoggingObj()

    /**
     * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun loggerFn(): Optional<String> = body.loggerFn()
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.apiType] with `apiType.orElse(null)`. */
        fun apiType(apiType: Optional<String>) = apiType(apiType.getOrNull())
        ...
        /** Alias for calling [Builder.litellmCallId] with `litellmCallId.orElse(null)`. */
        fun litellmCallId(litellmCallId: Optional<String>) =
            litellmCallId(litellmCallId.getOrNull())
        ...
        /** Alias for calling [Builder.litellmLoggingObj] with `litellmLoggingObj.orElse(null)`. */
        fun litellmLoggingObj(litellmLoggingObj: Optional<LitellmLoggingObj>) =
            litellmLoggingObj(litellmLoggingObj.getOrNull())
        ...
        /** Alias for calling [Builder.loggerFn] with `loggerFn.orElse(null)`. */
        fun loggerFn(loggerFn: Optional<String>) = loggerFn(loggerFn.getOrNull())
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun apiType(): Optional<String> = apiType.getOptional("api_type")
         ...
         *   server responded with an unexpected value).
         */
        fun customLlmProvider(): Optional<CustomLlmProvider> =
         ...
         *   server responded with an unexpected value).
         */
        fun input(): Optional<List<String>> = input.getOptional("input")

        /**
         * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
        fun litellmCallId(): Optional<String> = litellmCallId.getOptional("litellm_call_id")

        /**
         * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
        fun litellmLoggingObj(): Optional<LitellmLoggingObj> =
            litellmLoggingObj.getOptional("litellm_logging_obj")

        /**
         * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
        fun loggerFn(): Optional<String> = loggerFn.getOptional("logger_fn")
        ...
        fun validate(): Body = apply {
            ...
            apiVersion()
            caching()
            customLlmProvider().ifPresent { it.validate() }
            input()
            litellmCallId()
            litellmLoggingObj().ifPresent { it.validate() }
            loggerFn()
            timeout()
            user()
            validated = true
        ...
        internal fun validity(): Int =
            (if (bodyModel.asKnown().isPresent) 1 else 0) +
                ...
                (if (apiType.asKnown().isPresent) 1 else 0) +
                (if (apiVersion.asKnown().isPresent) 1 else 0) +
                (if (caching.asKnown().isPresent) 1 else 0) +
                (customLlmProvider.asKnown().getOrNull()?.validity() ?: 0) +
                (input.asKnown().getOrNull()?.size ?: 0) +
                (if (litellmCallId.asKnown().isPresent) 1 else 0) +
                (litellmLoggingObj.asKnown().getOrNull()?.validity() ?: 0) +
                (if (loggerFn.asKnown().isPresent) 1 else 0) +
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmStatic fun ofString(string: String) = CustomLlmProvider(string = string)
