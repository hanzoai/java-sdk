...
private constructor(
    ...
    fun responseModel(): Optional<JsonValue> = Optional.ofNullable(responseModel)
    ...
    companion object {
        ...
        @JvmStatic fun none(): TeamListAvailableParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.responseModel] with `responseModel.orElse(null)`. */
        fun responseModel(responseModel: Optional<JsonValue>) =
            responseModel(responseModel.getOrNull())
