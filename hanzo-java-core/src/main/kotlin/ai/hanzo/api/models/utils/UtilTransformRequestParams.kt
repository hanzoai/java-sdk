...
private constructor(
    ...
    class CallType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val AEMBEDDING = of("aembedding")

            @JvmField val COMPLETION = of("completion")

            @JvmField val ACOMPLETION = of("acompletion")

            @JvmField val ATEXT_COMPLETION = of("atext_completion")
            ...
            @JvmField val ATRANSCRIPTION = of("atranscription")

            @JvmField val TRANSCRIPTION = of("transcription")

            @JvmField val ASPEECH = of("aspeech")
            ...
            @JvmField val CREATE_BATCH = of("create_batch")

            @JvmField val ACREATE_BATCH = of("acreate_batch")

            @JvmField val ARETRIEVE_BATCH = of("aretrieve_batch")

            @JvmField val RETRIEVE_BATCH = of("retrieve_batch")

            @JvmField val PASS_THROUGH_ENDPOINT = of("pass_through_endpoint")

            @JvmField val ANTHROPIC_MESSAGES = of("anthropic_messages")

            @JvmField val GET_ASSISTANTS = of("get_assistants")

            @JvmField val AGET_ASSISTANTS = of("aget_assistants")

            @JvmField val CREATE_ASSISTANTS = of("create_assistants")

            @JvmField val ACREATE_ASSISTANTS = of("acreate_assistants")

            @JvmField val DELETE_ASSISTANT = of("delete_assistant")

            @JvmField val ADELETE_ASSISTANT = of("adelete_assistant")

            @JvmField val ACREATE_THREAD = of("acreate_thread")

            @JvmField val CREATE_THREAD = of("create_thread")

            @JvmField val AGET_THREAD = of("aget_thread")

            @JvmField val GET_THREAD = of("get_thread")

            @JvmField val A_ADD_MESSAGE = of("a_add_message")

            @JvmField val ADD_MESSAGE = of("add_message")

            @JvmField val AGET_MESSAGES = of("aget_messages")

            @JvmField val GET_MESSAGES = of("get_messages")

            @JvmField val ARUN_THREAD = of("arun_thread")

            @JvmField val RUN_THREAD = of("run_thread")

            @JvmField val ARUN_THREAD_STREAM = of("arun_thread_stream")

            @JvmField val RUN_THREAD_STREAM = of("run_thread_stream")

            @JvmField val AFILE_RETRIEVE = of("afile_retrieve")

            @JvmField val FILE_RETRIEVE = of("file_retrieve")

            @JvmField val AFILE_DELETE = of("afile_delete")

            @JvmField val FILE_DELETE = of("file_delete")

            @JvmField val AFILE_LIST = of("afile_list")

            @JvmField val FILE_LIST = of("file_list")

            @JvmField val ACREATE_FILE = of("acreate_file")

            @JvmField val CREATE_FILE = of("create_file")

            @JvmField val AFILE_CONTENT = of("afile_content")

            @JvmField val FILE_CONTENT = of("file_content")

            @JvmField val CREATE_FINE_TUNING_JOB = of("create_fine_tuning_job")
            ...
            @JvmField val ALIST_FINE_TUNING_JOBS = of("alist_fine_tuning_jobs")

            @JvmField val LIST_FINE_TUNING_JOBS = of("list_fine_tuning_jobs")

            @JvmField val ARETRIEVE_FINE_TUNING_JOB = of("aretrieve_fine_tuning_job")

            @JvmField val RETRIEVE_FINE_TUNING_JOB = of("retrieve_fine_tuning_job")
