...
private constructor(
    ...
    fun modelGroup(): Optional<String> = Optional.ofNullable(modelGroup)
    ...
    companion object {
        ...
        @JvmStatic fun none(): ModelGroupRetrieveInfoParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.modelGroup] with `modelGroup.orElse(null)`. */
        fun modelGroup(modelGroup: Optional<String>) = modelGroup(modelGroup.getOrNull())
