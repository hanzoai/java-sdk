...
private constructor(
     ...
     * ```java
     * MyClass myObject = keyGenerateParams.aliases().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = keyGenerateParams.config().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = keyGenerateParams.metadata().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = keyGenerateParams.modelMaxBudget().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = keyGenerateParams.modelRpmLimit().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = keyGenerateParams.modelTpmLimit().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = keyGenerateParams.permissions().convert(MyClass.class);
     * ```
     */
     ...
     *   server responded with an unexpected value).
     */
    fun softBudget(): Optional<Double> = body.softBudget()
    ...
    companion object {
        ...
        @JvmStatic fun none(): KeyGenerateParams = builder().build()
