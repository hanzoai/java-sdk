...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun members(): Optional<List<Member>> = Optional.ofNullable(members.getNullable("members"))
     ...
     *   server responded with an unexpected value).
     */
    fun teams(): Optional<List<Team>> = Optional.ofNullable(teams.getNullable("teams"))
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun members(): Optional<List<JsonValue>> =
            Optional.ofNullable(members.getNullable("members"))
