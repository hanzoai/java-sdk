...
private constructor(
     ...
     * ```java
     * MyClass myObject = userCreateResponse.aliases().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = userCreateResponse.config().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = userCreateResponse.llmBudgetTable().convert(MyClass.class);
     * ```
     */
    @JsonProperty("llm_budget_table")
    @ExcludeMissing
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = userCreateResponse.metadata().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = userCreateResponse.modelMaxBudget().convert(MyClass.class);
     * ```
     */
    @JsonProperty("model_max_budget")
    @ExcludeMissing
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = userCreateResponse.modelRpmLimit().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = userCreateResponse.modelTpmLimit().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = userCreateResponse.permissions().convert(MyClass.class);
     * ```
     */
