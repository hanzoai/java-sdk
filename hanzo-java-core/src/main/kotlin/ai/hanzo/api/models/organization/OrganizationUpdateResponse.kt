...
private constructor(
     ...
     * ```java
     * MyClass myObject = organizationUpdateResponse.metadata().convert(MyClass.class);
     * ```
     */
     ...
     *   server responded with an unexpected value).
     */
    fun teams(): Optional<List<Team>> = teams.getOptional("teams")
    ...
    private constructor(
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```java
         * MyClass myObject = member.user().convert(MyClass.class);
         * ```
         */
    ...
    private constructor(
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```java
         * MyClass myObject = team.metadata().convert(MyClass.class);
         * ```
         */
        @JsonProperty("metadata") @ExcludeMissing fun _metadata(): JsonValue = metadata
