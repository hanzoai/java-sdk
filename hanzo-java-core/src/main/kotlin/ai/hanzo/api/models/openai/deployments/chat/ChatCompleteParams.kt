...
private constructor(
    ...
    fun pathModel(): Optional<String> = Optional.ofNullable(pathModel)
     ...
     */
    fun caching(): Optional<Boolean> = body.caching()

    /**
     * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun contextWindowFallbackDict(): Optional<ContextWindowFallbackDict> =
     ...
     *   server responded with an unexpected value).
     */
    fun fallbacks(): Optional<List<String>> = body.fallbacks()
     ...
     *   server responded with an unexpected value).
     */
    fun numRetries(): Optional<Long> = body.numRetries()
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.pathModel] with `pathModel.orElse(null)`. */
        fun pathModel(pathModel: Optional<String>) = pathModel(pathModel.getOrNull())
        ...
        fun caching(caching: Optional<Boolean>) = caching(caching.getOrNull())
        ...
        fun contextWindowFallbackDict(
            contextWindowFallbackDict: Optional<ContextWindowFallbackDict>
        ...
        fun fallbacks(fallbacks: Optional<List<String>>) = fallbacks(fallbacks.getOrNull())
        ...
        fun functions(functions: Optional<List<Function>>) = functions(functions.getOrNull())
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun caching(): Optional<Boolean> = caching.getOptional("caching")
         ...
         */
        fun contextWindowFallbackDict(): Optional<ContextWindowFallbackDict> =
            contextWindowFallbackDict.getOptional("context_window_fallback_dict")

        /**
         * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
        fun fallbacks(): Optional<List<String>> = fallbacks.getOptional("fallbacks")
        ...
        fun validate(): Body = apply {
            ...
            bodyModel()
            caching()
            contextWindowFallbackDict().ifPresent { it.validate() }
            fallbacks()
            frequencyPenalty()
        ...
        internal fun validity(): Int =
            (messages.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
                (if (bodyModel.asKnown().isPresent) 1 else 0) +
                (if (caching.asKnown().isPresent) 1 else 0) +
                (contextWindowFallbackDict.asKnown().getOrNull()?.validity() ?: 0) +
    ...
    private constructor(
        ...
        fun chatCompletionUser(): Optional<ChatCompletionUserMessage> =
            Optional.ofNullable(chatCompletionUser)

        fun chatCompletionAssistant(): Optional<ChatCompletionAssistantMessage> =
            Optional.ofNullable(chatCompletionAssistant)

        fun chatCompletionTool(): Optional<ChatCompletionToolMessage> =
            Optional.ofNullable(chatCompletionTool)

        fun chatCompletionSystem(): Optional<ChatCompletionSystemMessage> =
            Optional.ofNullable(chatCompletionSystem)

        fun chatCompletionFunction(): Optional<ChatCompletionFunctionMessage> =
            Optional.ofNullable(chatCompletionFunction)

        fun chatCompletionDeveloper(): Optional<ChatCompletionDeveloperMessage> =
            Optional.ofNullable(chatCompletionDeveloper)
        ...
        private constructor(
             ...
             */
            fun cacheControl(): Optional<CacheControl> = cacheControl.getOptional("cache_control")
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    fun chatCompletionTextObject(): Optional<ChatCompletionTextObject> =
                        Optional.ofNullable(chatCompletionTextObject)

                    fun chatCompletionImageObject(): Optional<ChatCompletionImageObject> =
                        Optional.ofNullable(chatCompletionImageObject)

                    fun chatCompletionAudioObject(): Optional<ChatCompletionAudioObject> =
                        Optional.ofNullable(chatCompletionAudioObject)

                    fun chatCompletionDocumentObject(): Optional<ChatCompletionDocumentObject> =
                        Optional.ofNullable(chatCompletionDocumentObject)

                    fun chatCompletionVideoObject(): Optional<ChatCompletionVideoObject> =
                        Optional.ofNullable(chatCompletionVideoObject)

                    fun chatCompletionFileObject(): Optional<ChatCompletionFileObject> =
                        Optional.ofNullable(chatCompletionFileObject)
                    ...
                    private constructor(
                        ...
                        private constructor(
                            ...
                            fun chatCompletionImageUrlObject():
                                Optional<ChatCompletionImageUrlObject> =
                                Optional.ofNullable(chatCompletionImageUrlObject)
                            ...
                            companion object {
                                ...
                                @JvmStatic fun ofString(string: String) = ImageUrl(string = string)
                    ...
                    private constructor(
                        ...
                        class Builder internal constructor() {
                             ...
                             */
                            fun citations(citations: Optional<Citations>) =
                    ...
                    private constructor(
                        ...
                        internal fun validity(): Int =
                            type.let { if (it == JsonValue.from("video_url")) 1 else 0 } +
                                (videoUrl.asKnown().getOrNull()?.validity() ?: 0)
                        ...
                        private constructor(
                            ...
                            fun chatCompletionVideoUrlObject():
                                Optional<ChatCompletionVideoUrlObject> =
                                Optional.ofNullable(chatCompletionVideoUrlObject)
                            ...
                            companion object {
                                ...
                                @JvmStatic fun ofString(string: String) = VideoUrl(string = string)
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                /**
                 * Alias for calling [Builder.thinkingBlocks] with `thinkingBlocks.orElse(null)`.
                 */
            ...
            internal fun validity(): Int =
                role.let { if (it == JsonValue.from("assistant")) 1 else 0 } +
                    ...
                    (thinkingBlocks.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    fun chatCompletionThinkingBlock(): Optional<ChatCompletionThinkingBlock> =
                        Optional.ofNullable(chatCompletionThinkingBlock)
                    ...
                    private constructor(
                         ...
                         *   type (e.g. if the server responded with an unexpected value).
                         */
                        fun thinking(): Optional<String> = thinking.getOptional("thinking")
            ...
            private constructor(
                ...
                fun chatCompletionRedacted(): Optional<ChatCompletionRedactedThinkingBlock> =
        ...
        private constructor(
            ...
            private constructor(
                ...
                fun chatCompletionTextObjects(): Optional<List<ChatCompletionTextObject>> =
                    Optional.ofNullable(chatCompletionTextObjects)
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                /** Alias for calling [Builder.toolCallId] with `toolCallId.orElse(null)`. */
                fun toolCallId(toolCallId: Optional<String>) = toolCallId(toolCallId.getOrNull())
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmStatic fun ofString(string: String) = FunctionCall(string = string)
