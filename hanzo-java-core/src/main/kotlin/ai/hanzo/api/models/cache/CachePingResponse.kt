...
private constructor(
     ...
     */
    fun healthCheckCacheParams(): Optional<HealthCheckCacheParams> =
     ...
     *   server responded with an unexpected value).
     */
    fun litellmCacheParams(): Optional<String> =
    ...
    class Builder internal constructor() {
         ...
         */
        fun healthCheckCacheParams(healthCheckCacheParams: Optional<HealthCheckCacheParams>) =
         ...
         */
        fun litellmCacheParams(litellmCacheParams: Optional<String>) =
        ...
        /** Alias for calling [Builder.pingResponse] with `pingResponse.orElse(null)`. */
        fun pingResponse(pingResponse: Optional<Boolean>) = pingResponse(pingResponse.getOrNull())
        ...
        /** Alias for calling [Builder.setCacheResponse] with `setCacheResponse.orElse(null)`. */
        fun setCacheResponse(setCacheResponse: Optional<String>) =
            setCacheResponse(setCacheResponse.getOrNull())
