...
private constructor(
     ...
     * ```java
     * MyClass myObject = spendRetrieveReportResponse.metadata().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = spendRetrieveReportResponse.requestTags().convert(MyClass.class);
     * ```
     */
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.cacheHit] with `cacheHit.orElse(null)`. */
        fun cacheHit(cacheHit: Optional<String>) = cacheHit(cacheHit.getOrNull())
        ...
        /** Alias for calling [Builder.cacheKey] with `cacheKey.orElse(null)`. */
        fun cacheKey(cacheKey: Optional<String>) = cacheKey(cacheKey.getOrNull())
        ...
        /**
         * Alias for calling [Builder.requesterIpAddress] with `requesterIpAddress.orElse(null)`.
         */
        fun requesterIpAddress(requesterIpAddress: Optional<String>) =
            requesterIpAddress(requesterIpAddress.getOrNull())
    ...
    internal fun validity(): Int =
        (if (apiKey.asKnown().isPresent) 1 else 0) +
            (if (callType.asKnown().isPresent) 1 else 0) +
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = endTime.accept(new EndTime.Visitor<Optional<String>>() {
         *     @Override
        ...
        companion object {
            ...
            @JvmStatic fun ofString(string: String) = EndTime(string = string)
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = messages.accept(new Messages.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitString(String string) {
         *         return Optional.of(string.toString());
         *     }
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = startTime.accept(new StartTime.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitString(String string) {
         *         return Optional.of(string.toString());
         *     }
        ...
        companion object {
            ...
            @JvmStatic fun ofString(string: String) = StartTime(string = string)
