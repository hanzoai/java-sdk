...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun members(): Optional<List<OrganizationMembershipTable>> = members.getOptional("members")
    ...
    class Builder internal constructor() {
        ...
        /**
         * Alias for calling [Builder.litellmBudgetTable] with `litellmBudgetTable.orElse(null)`.
         */
        ...
        fun users(users: Optional<List<User>>) = users(users.getOrNull())
    ...
    private constructor(
         ...
         * ```java
         * MyClass myObject = team.litellmModelTable().convert(MyClass.class);
         * ```
         */
        @JsonProperty("litellm_model_table")
        @ExcludeMissing
