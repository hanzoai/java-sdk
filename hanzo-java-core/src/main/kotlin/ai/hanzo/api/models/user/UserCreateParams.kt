...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun organizations(): Optional<List<String>> = body.organizations()
     ...
     *   server responded with an unexpected value).
     */
    fun ssoUserId(): Optional<String> = body.ssoUserId()
     ...
     *   server responded with an unexpected value).
     */
    fun teams(): Optional<Teams> = body.teams()
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.organizations] with `organizations.orElse(null)`. */
        fun organizations(organizations: Optional<List<String>>) =
            organizations(organizations.getOrNull())
        ...
        fun teams(teams: Optional<Teams>) = teams(teams.getOrNull())
    ...
    private constructor(
        ...
        fun newUserRequest(): Optional<List<NewUserRequestTeam>> =
            Optional.ofNullable(newUserRequest)
        ...
        companion object {
            ...
            @JvmStatic fun ofStrings(strings: List<String>) = Teams(strings = strings.toImmutable())
        ...
        private constructor(
            ...
            fun maxBudgetInTeam(): Optional<Double> =
                maxBudgetInTeam.getOptional("max_budget_in_team")
            ...
            class Builder internal constructor() {
                ...
                /**
                 * Alias for calling [Builder.maxBudgetInTeam] with `maxBudgetInTeam.orElse(null)`.
                 */
                fun maxBudgetInTeam(maxBudgetInTeam: Optional<Double>) =
                    maxBudgetInTeam(maxBudgetInTeam.getOrNull())
