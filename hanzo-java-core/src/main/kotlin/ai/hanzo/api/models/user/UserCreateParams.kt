...
private constructor(
     ...
     * ```java
     * MyClass myObject = userCreateParams.aliases().convert(MyClass.class);
     * ```
     */
     ...
     *   server responded with an unexpected value).
     */
    fun autoCreateKey(): Optional<Boolean> = body.autoCreateKey()
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = userCreateParams.config().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = userCreateParams.metadata().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = userCreateParams.modelMaxBudget().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = userCreateParams.modelRpmLimit().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = userCreateParams.modelTpmLimit().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = userCreateParams.permissions().convert(MyClass.class);
     * ```
     */
     ...
     *   server responded with an unexpected value).
     */
    fun sendInviteEmail(): Optional<Boolean> = body.sendInviteEmail()
     ...
     *   server responded with an unexpected value).
     */
    fun teams(): Optional<List<JsonValue>> = body.teams()
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.teams] with `teams.orElse(null)`. */
        fun teams(teams: Optional<List<JsonValue>>) = teams(teams.getOrNull())
    ...
    private constructor(
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```java
         * MyClass myObject = body.aliases().convert(MyClass.class);
         * ```
         */
         ...
         *   server responded with an unexpected value).
         */
        fun autoCreateKey(): Optional<Boolean> = autoCreateKey.getOptional("auto_create_key")
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```java
         * MyClass myObject = body.config().convert(MyClass.class);
         * ```
         */
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```java
         * MyClass myObject = body.modelMaxBudget().convert(MyClass.class);
         * ```
         */
        @JsonProperty("model_max_budget")
        @ExcludeMissing
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```java
         * MyClass myObject = body.modelRpmLimit().convert(MyClass.class);
         * ```
         */
        @JsonProperty("model_rpm_limit")
        @ExcludeMissing
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```java
         * MyClass myObject = body.modelTpmLimit().convert(MyClass.class);
         * ```
         */
        @JsonProperty("model_tpm_limit")
        @ExcludeMissing
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```java
         * MyClass myObject = body.permissions().convert(MyClass.class);
         * ```
         */
         ...
         *   server responded with an unexpected value).
         */
        fun teams(): Optional<List<JsonValue>> = teams.getOptional("teams")
