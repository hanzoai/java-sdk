...
private constructor(
     ...
     * ```java
     * MyClass myObject = keyBlockResponse.aliases().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = keyBlockResponse.config().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = keyBlockResponse.llmBudgetTable().convert(MyClass.class);
     * ```
     */
    @JsonProperty("llm_budget_table")
    @ExcludeMissing
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = keyBlockResponse.metadata().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = keyBlockResponse.modelMaxBudget().convert(MyClass.class);
     * ```
     */
    @JsonProperty("model_max_budget")
    @ExcludeMissing
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = keyBlockResponse.modelSpend().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = keyBlockResponse.permissions().convert(MyClass.class);
     * ```
     */
