...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun keyRotationAt(): Optional<OffsetDateTime> = keyRotationAt.getOptional("key_rotation_at")

    /**
     * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun lastRotationAt(): Optional<OffsetDateTime> = lastRotationAt.getOptional("last_rotation_at")
    ...
    class Builder internal constructor() {
        ...
        fun rotationCount(rotationCount: Optional<Long>) = rotationCount(rotationCount.getOrNull())
