...
private constructor(
     ...
     */
    fun completionResponse(): Optional<CompletionResponse> = body.completionResponse()
    ...
    companion object {
        ...
        @JvmStatic fun none(): SpendCalculateSpendParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        /**
         * Alias for calling [Builder.completionResponse] with `completionResponse.orElse(null)`.
         */
        fun completionResponse(completionResponse: Optional<CompletionResponse>) =
            completionResponse(completionResponse.getOrNull())
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun completionResponse(): Optional<CompletionResponse> =
            completionResponse.getOptional("completion_response")
        ...
        class Builder internal constructor() {
            ...
            /**
             * Alias for calling [Builder.completionResponse] with
             * `completionResponse.orElse(null)`.
             */
            fun completionResponse(completionResponse: Optional<CompletionResponse>) =
                completionResponse(completionResponse.getOrNull())
        ...
        fun validate(): Body = apply {
            ...
            completionResponse().ifPresent { it.validate() }
            messages()
            model()
            validated = true
        }
        ...
        internal fun validity(): Int =
            (completionResponse.asKnown().getOrNull()?.validity() ?: 0) +
