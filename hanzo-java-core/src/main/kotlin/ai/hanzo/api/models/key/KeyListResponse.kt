...
private constructor(
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = key.accept(new Key.Visitor<Optional<String>>() {
         *     @Override
        ...
        private constructor(
             ...
             * method:
             * ```java
             * MyClass myObject = userApiKeyAuth.aliases().convert(MyClass.class);
             * ```
             */
             ...
             * method:
             * ```java
             * MyClass myObject = userApiKeyAuth.config().convert(MyClass.class);
             * ```
             */
             ...
             * method:
             * ```java
             * MyClass myObject = userApiKeyAuth.llmBudgetTable().convert(MyClass.class);
             * ```
             */
            @JsonProperty("llm_budget_table")
            @ExcludeMissing
             ...
             * method:
             * ```java
             * MyClass myObject = userApiKeyAuth.metadata().convert(MyClass.class);
             * ```
             */
             ...
             * method:
             * ```java
             * MyClass myObject = userApiKeyAuth.modelMaxBudget().convert(MyClass.class);
             * ```
             */
            @JsonProperty("model_max_budget")
            @ExcludeMissing
             ...
             * method:
             * ```java
             * MyClass myObject = userApiKeyAuth.modelSpend().convert(MyClass.class);
             * ```
             */
             ...
             * method:
             * ```java
             * MyClass myObject = userApiKeyAuth.permissions().convert(MyClass.class);
             * ```
             */
             ...
             * method:
             * ```java
             * MyClass myObject = userApiKeyAuth.teamMetadata().convert(MyClass.class);
             * ```
             */
            @JsonProperty("team_metadata")
            @ExcludeMissing
             ...
             * method:
             * ```java
             * MyClass myObject = userApiKeyAuth.teamModelAliases().convert(MyClass.class);
             * ```
             */
            @JsonProperty("team_model_aliases")
            @ExcludeMissing
            ...
            private constructor(
                 ...
                 * import java.util.Optional;
                 *
                 * Optional<String> result = expires.accept(new Expires.Visitor<Optional<String>>() {
                 *     @Override
                 *     public Optional<String> visitString(String string) {
                 *         return Optional.of(string.toString());
                 *     }
