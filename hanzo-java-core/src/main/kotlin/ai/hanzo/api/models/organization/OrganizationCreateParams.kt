...
private constructor(
     ...
     * ```java
     * MyClass myObject = organizationCreateParams.metadata().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = organizationCreateParams.modelMaxBudget().convert(MyClass.class);
     * ```
     */
