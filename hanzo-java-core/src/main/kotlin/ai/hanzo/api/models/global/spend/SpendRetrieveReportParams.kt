...
private constructor(
    ...
    fun internalUserId(): Optional<String> = Optional.ofNullable(internalUserId)
    ...
    companion object {
        ...
        @JvmStatic fun none(): SpendRetrieveReportParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.internalUserId] with `internalUserId.orElse(null)`. */
        fun internalUserId(internalUserId: Optional<String>) =
            internalUserId(internalUserId.getOrNull())
