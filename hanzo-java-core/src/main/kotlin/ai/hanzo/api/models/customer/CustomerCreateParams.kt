...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun allowedModelRegion(): Optional<AllowedModelRegion> = body.allowedModelRegion()
     ...
     *   server responded with an unexpected value).
     */
    fun defaultModel(): Optional<String> = body.defaultModel()
    ...
    private constructor(
        ...
        fun modelMaxBudget(): Optional<ModelMaxBudget> =
            Optional.ofNullable(modelMaxBudget.getNullable("model_max_budget"))
        ...
        class Builder internal constructor() {
            ...
            /** Alias for calling [Builder.defaultModel] with `defaultModel.orElse(null)`. */
            fun defaultModel(defaultModel: Optional<String>) =
                defaultModel(defaultModel.getOrNull())
