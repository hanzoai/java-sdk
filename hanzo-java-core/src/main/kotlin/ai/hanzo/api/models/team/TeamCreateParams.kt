...
private constructor(
     ...
     * ```java
     * MyClass myObject = teamCreateParams.metadata().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = teamCreateParams.modelAliases().convert(MyClass.class);
     * ```
     */
    ...
    private constructor(
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```java
         * MyClass myObject = body.modelAliases().convert(MyClass.class);
         * ```
         */
