...
private constructor(
     ...
     */
    fun admins(): Optional<List<JsonValue>> = body.admins()
     ...
     *   server responded with an unexpected value).
     */
    fun members(): Optional<List<JsonValue>> = body.members()

    /**
     * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun membersWithRoles(): Optional<List<Member>> = body.membersWithRoles()
     ...
     *   server responded with an unexpected value).
     */
    fun teamMemberPermissions(): Optional<List<String>> = body.teamMemberPermissions()
    ...
    companion object {
        ...
        @JvmStatic fun none(): TeamCreateParams = builder().build()
