...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun newKey(): Optional<String> = newKey.getOptional("new_key")
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.newKey] with `newKey.orElse(null)`. */
        fun newKey(newKey: Optional<String>) = newKey(newKey.getOrNull())
    ...
    internal fun validity(): Int =
        (aliases.asKnown().getOrNull()?.validity() ?: 0) +
            ...
            (if (newKey.asKnown().isPresent) 1 else 0) +
    ...
    class KeyType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val LLM_API = of("llm_api")
