...
private constructor(
     ...
     * ```java
     * MyClass myObject = credentialCreateParams.credentialInfo().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = credentialCreateParams.credentialValues().convert(MyClass.class);
     * ```
     */
    ...
    private constructor(
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```java
         * MyClass myObject = body.credentialInfo().convert(MyClass.class);
         * ```
         */
        @JsonProperty("credential_info")
        @ExcludeMissing
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```java
         * MyClass myObject = body.credentialValues().convert(MyClass.class);
         * ```
         */
        @JsonProperty("credential_values")
        @ExcludeMissing
