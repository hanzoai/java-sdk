...
private constructor(
     ...
     */
    fun credentialValues(): Optional<CredentialValues> = body.credentialValues()

    /**
     * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun modelId(): Optional<String> = body.modelId()
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.credentialValues] with `credentialValues.orElse(null)`. */
        fun credentialValues(credentialValues: Optional<CredentialValues>) =
            credentialValues(credentialValues.getOrNull())
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun credentialValues(): Optional<CredentialValues> =
            credentialValues.getOptional("credential_values")
        ...
        fun validate(): Body = apply {
            ...
            credentialName()
            credentialValues().ifPresent { it.validate() }
            modelId()
            validated = true
        }
        ...
        internal fun validity(): Int =
            (credentialInfo.asKnown().getOrNull()?.validity() ?: 0) +
                (if (credentialName.asKnown().isPresent) 1 else 0) +
                (credentialValues.asKnown().getOrNull()?.validity() ?: 0) +
