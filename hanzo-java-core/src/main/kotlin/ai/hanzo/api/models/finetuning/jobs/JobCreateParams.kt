...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun integrations(): Optional<List<String>> = body.integrations()
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.hyperparameters] with `hyperparameters.orElse(null)`. */
        fun hyperparameters(hyperparameters: Optional<Hyperparameters>) =
            hyperparameters(hyperparameters.getOrNull())
        ...
        fun integrations(integrations: Optional<List<String>>) =
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (customLlmProvider.asKnown().getOrNull()?.validity() ?: 0) +
                ...
                (integrations.asKnown().getOrNull()?.size ?: 0) +
    ...
    class CustomLlmProvider @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmField val VERTEX_AI = of("vertex_ai")

            @JvmStatic fun of(value: String) = CustomLlmProvider(JsonField.of(value))
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /**
             * Alias for calling [Builder.learningRateMultiplier] with
             * `learningRateMultiplier.orElse(null)`.
             */
            fun learningRateMultiplier(learningRateMultiplier: Optional<LearningRateMultiplier>) =
                learningRateMultiplier(learningRateMultiplier.getOrNull())
            ...
            /** Alias for calling [Builder.nEpochs] with `nEpochs.orElse(null)`. */
            fun nEpochs(nEpochs: Optional<NEpochs>) = nEpochs(nEpochs.getOrNull())
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return /* spotless:off */ other is BatchSize && string == other.string && integer == other.integer /* spotless:on */
            }
            ...
            companion object {
                ...
                @JvmStatic fun ofString(string: String) = BatchSize(string = string)
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return /* spotless:off */ other is LearningRateMultiplier && string == other.string && number == other.number /* spotless:on */
            }

            override fun hashCode(): Int = /* spotless:off */ Objects.hash(string, number) /* spotless:on */
            ...
            companion object {
                ...
                @JvmStatic fun ofString(string: String) = LearningRateMultiplier(string = string)
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return /* spotless:off */ other is NEpochs && string == other.string && integer == other.integer /* spotless:on */
            }
            ...
            companion object {
                ...
                @JvmStatic fun ofString(string: String) = NEpochs(string = string)
