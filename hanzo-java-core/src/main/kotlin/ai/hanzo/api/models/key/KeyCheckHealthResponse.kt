...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.loggingCallbacks] with `loggingCallbacks.orElse(null)`. */
        fun loggingCallbacks(loggingCallbacks: Optional<LoggingCallbacks>) =
            loggingCallbacks(loggingCallbacks.getOrNull())
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun details(details: Optional<String>) = details(details.getOrNull())
