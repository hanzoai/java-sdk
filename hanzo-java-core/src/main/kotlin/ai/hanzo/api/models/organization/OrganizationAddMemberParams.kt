...
private constructor(
     ...
     */
    fun maxBudgetInOrganization(): Optional<Double> = body.maxBudgetInOrganization()
    ...
    class Builder internal constructor() {
        ...
        /**
         * Alias for calling [Builder.maxBudgetInOrganization] with
         * `maxBudgetInOrganization.orElse(null)`.
         */
        fun maxBudgetInOrganization(maxBudgetInOrganization: Optional<Double>) =
            maxBudgetInOrganization(maxBudgetInOrganization.getOrNull())
    ...
    private constructor(
        ...
        fun orgMembers(): Optional<List<OrgMember>> = Optional.ofNullable(orgMembers)

        fun org(): Optional<OrgMember> = Optional.ofNullable(org)
         ...
         *     @Override
         *     public Optional<String> visitOrgMembers(List<OrgMember> orgMembers) {
         *         return Optional.of(orgMembers.toString());
         *     }
         *
         *     // ...
         *
