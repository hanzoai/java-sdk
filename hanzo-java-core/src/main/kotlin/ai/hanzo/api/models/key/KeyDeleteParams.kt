...
private constructor(
     ...
     */
    fun keyAliases(): Optional<List<String>> = body.keyAliases()
    ...
    companion object {
        ...
        @JvmStatic fun none(): KeyDeleteParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.keyAliases] with `keyAliases.orElse(null)`. */
        fun keyAliases(keyAliases: Optional<List<String>>) = keyAliases(keyAliases.getOrNull())
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (keyAliases.asKnown().getOrNull()?.size ?: 0) + (keys.asKnown().getOrNull()?.size ?: 0)
