...
private constructor(
     ...
     * ```java
     * MyClass myObject = utilTransformRequestResponse.rawRequestBody().convert(MyClass.class);
     * ```
     */
    @JsonProperty("raw_request_body")
    @ExcludeMissing
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = utilTransformRequestResponse.rawRequestHeaders().convert(MyClass.class);
     * ```
     */
    @JsonProperty("raw_request_headers")
    @ExcludeMissing
