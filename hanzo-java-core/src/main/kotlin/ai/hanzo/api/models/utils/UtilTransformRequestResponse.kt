...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun rawRequestBody(): Optional<RawRequestBody> = rawRequestBody.getOptional("raw_request_body")

    /**
     * @throws HanzoInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun rawRequestHeaders(): Optional<RawRequestHeaders> =
        rawRequestHeaders.getOptional("raw_request_headers")
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.rawRequestApiBase] with `rawRequestApiBase.orElse(null)`. */
        fun rawRequestApiBase(rawRequestApiBase: Optional<String>) =
            rawRequestApiBase(rawRequestApiBase.getOrNull())
        ...
        /** Alias for calling [Builder.rawRequestBody] with `rawRequestBody.orElse(null)`. */
        fun rawRequestBody(rawRequestBody: Optional<RawRequestBody>) =
            rawRequestBody(rawRequestBody.getOrNull())
        ...
        /** Alias for calling [Builder.rawRequestHeaders] with `rawRequestHeaders.orElse(null)`. */
        fun rawRequestHeaders(rawRequestHeaders: Optional<RawRequestHeaders>) =
            rawRequestHeaders(rawRequestHeaders.getOrNull())
    ...
    fun validate(): UtilTransformRequestResponse = apply {
        ...
        error()
        rawRequestApiBase()
        rawRequestBody().ifPresent { it.validate() }
        rawRequestHeaders().ifPresent { it.validate() }
        validated = true
    }
    ...
    internal fun validity(): Int =
        (if (error.asKnown().isPresent) 1 else 0) +
            (if (rawRequestApiBase.asKnown().isPresent) 1 else 0) +
            (rawRequestBody.asKnown().getOrNull()?.validity() ?: 0) +
            (rawRequestHeaders.asKnown().getOrNull()?.validity() ?: 0)
