...
internal class OrganizationListResponseTest {
    ...
    fun create() {
        ...
        assertThat(organizationListResponse.members().getOrNull())
            .containsExactly(
                OrganizationListResponse.Member.builder()
                    .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .organizationId("organization_id")
        ...
        assertThat(organizationListResponse.organizationAlias()).contains("organization_alias")
        assertThat(organizationListResponse.organizationId()).contains("organization_id")
        assertThat(organizationListResponse.spend()).contains(0.0)
        assertThat(organizationListResponse.teams().getOrNull())
            .containsExactly(
                OrganizationListResponse.Team.builder()
                    .teamId("team_id")
                    .addAdmin(JsonValue.from(mapOf<String, Any>()))
