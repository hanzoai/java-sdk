...
internal class OrganizationUpdateMemberResponseTest {
    ...
    fun create() {
        ...
        assertThat(organizationUpdateMemberResponse.budgetId()).contains("budget_id")
        ...
        assertThat(organizationUpdateMemberResponse.spend()).contains(0.0)
        assertThat(organizationUpdateMemberResponse._user())
            .isEqualTo(JsonValue.from(mapOf<String, Any>()))
        assertThat(organizationUpdateMemberResponse.userRole()).contains("user_role")
    }
}
