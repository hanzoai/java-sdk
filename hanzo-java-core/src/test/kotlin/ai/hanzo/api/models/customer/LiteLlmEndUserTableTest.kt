...
internal class LiteLlmEndUserTableTest {
    ...
    fun create() {
        ...
        assertThat(liteLlmEndUserTable.alias()).contains("alias")
        assertThat(liteLlmEndUserTable.allowedModelRegion())
            .contains(LiteLlmEndUserTable.AllowedModelRegion.EU)
        assertThat(liteLlmEndUserTable.defaultModel()).contains("default_model")
        ...
        assertThat(liteLlmEndUserTable.spend()).contains(0.0)
    }
