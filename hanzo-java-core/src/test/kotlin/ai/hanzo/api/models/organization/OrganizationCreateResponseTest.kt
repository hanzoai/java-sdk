...
internal class OrganizationCreateResponseTest {
    ...
    fun create() {
        ...
        assertThat(organizationCreateResponse.objectPermissionId()).contains("object_permission_id")
        assertThat(organizationCreateResponse.organizationAlias()).contains("organization_alias")
        assertThat(organizationCreateResponse.spend()).contains(0.0)
        assertThat(organizationCreateResponse.users().getOrNull())
            .containsExactly(
                OrganizationCreateResponse.User.builder()
                    .userId("user_id")
                    .budgetDuration("budget_duration")
