...
internal class CachePingResponseTest {
    ...
    fun create() {
        ...
        assertThat(cachePingResponse.litellmCacheParams()).contains("litellm_cache_params")
        assertThat(cachePingResponse.pingResponse()).contains(true)
        assertThat(cachePingResponse.setCacheResponse()).contains("set_cache_response")
    }
