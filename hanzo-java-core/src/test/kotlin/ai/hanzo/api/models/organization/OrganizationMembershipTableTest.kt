...
internal class OrganizationMembershipTableTest {
    ...
    fun create() {
        ...
        assertThat(organizationMembershipTable.budgetId()).contains("budget_id")
        ...
        assertThat(organizationMembershipTable.spend()).contains(0.0)
        assertThat(organizationMembershipTable._user())
            .isEqualTo(JsonValue.from(mapOf<String, Any>()))
        assertThat(organizationMembershipTable.userRole()).contains("user_role")
    }
