...
internal class OrganizationDeleteResponseTest {
    ...
    fun create() {
        ...
        assertThat(organizationDeleteResponse.members().getOrNull())
            .containsExactly(
                OrganizationDeleteResponse.Member.builder()
                    .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .organizationId("organization_id")
        ...
        assertThat(organizationDeleteResponse.organizationAlias()).contains("organization_alias")
        assertThat(organizationDeleteResponse.organizationId()).contains("organization_id")
        assertThat(organizationDeleteResponse.spend()).contains(0.0)
        assertThat(organizationDeleteResponse.teams().getOrNull())
            .containsExactly(
                OrganizationDeleteResponse.Team.builder()
                    .teamId("team_id")
                    .addAdmin(JsonValue.from(mapOf<String, Any>()))
