...
internal class OrganizationUpdateResponseTest {
    ...
    fun create() {
        ...
        assertThat(organizationUpdateResponse.members().getOrNull())
            .containsExactly(
                OrganizationUpdateResponse.Member.builder()
                    .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .organizationId("organization_id")
        ...
        assertThat(organizationUpdateResponse.organizationAlias()).contains("organization_alias")
        assertThat(organizationUpdateResponse.organizationId()).contains("organization_id")
        assertThat(organizationUpdateResponse.spend()).contains(0.0)
        assertThat(organizationUpdateResponse.teams().getOrNull())
            .containsExactly(
                OrganizationUpdateResponse.Team.builder()
                    .teamId("team_id")
                    .addAdmin(JsonValue.from(mapOf<String, Any>()))
