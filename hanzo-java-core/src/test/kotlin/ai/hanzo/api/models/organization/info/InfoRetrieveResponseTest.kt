...
internal class InfoRetrieveResponseTest {
    ...
    fun create() {
        ...
        assertThat(infoRetrieveResponse.members().getOrNull())
            .containsExactly(
                InfoRetrieveResponse.Member.builder()
                    .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .organizationId("organization_id")
        ...
        assertThat(infoRetrieveResponse.organizationAlias()).contains("organization_alias")
        assertThat(infoRetrieveResponse.organizationId()).contains("organization_id")
        assertThat(infoRetrieveResponse.spend()).contains(0.0)
        assertThat(infoRetrieveResponse.teams().getOrNull())
            .containsExactly(
                InfoRetrieveResponse.Team.builder()
                    .teamId("team_id")
                    .addAdmin(JsonValue.from(mapOf<String, Any>()))
