...
dependencies {
    testImplementation(project(":hanzo-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../hanzo-java-core/src/main/resources/META-INF/proguard/hanzo-java-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../hanzo-java-core/src/main/resources/META-INF/proguard/hanzo-java-core.pro",
