...
import ai.hanzo.cloud.auth.Authentication;
import ai.hanzo.cloud.auth.HttpBasicAuth;
import ai.hanzo.cloud.auth.HttpBearerAuth;
import ai.hanzo.cloud.auth.ApiKeyAuth;
import ai.hanzo.cloud.auth.OAuth;
import ai.hanzo.cloud.auth.RetryingOAuth;
import ai.hanzo.cloud.auth.OAuthFlow;
...
public class ApiClient {
    ...
    protected String basePath = "https://api.hanzo.ai";
    ...
    public ApiClient() {
        ...
        authentications.put("serviceKey", new ApiKeyAuth("header", "X-API-Key"));
        authentications.put("s3Auth", new ApiKeyAuth("header", "Authorization"));
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://iam.hanzo.ai/oauth/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.hanzo.ai
     ...
     * @return a {@link ai.hanzo.cloud.ApiClient} object
     */
    ...
    */
     ...
     * @throws ai.hanzo.cloud.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws ai.hanzo.cloud.ApiException If fail to serialize the given object
     */
     ...
     * @throws ai.hanzo.cloud.ApiException If fail to read file content from response and write to disk
     ...
     * @throws ai.hanzo.cloud.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws ai.hanzo.cloud.ApiException If the response has an unsuccessful status code or
     ...
     * @throws ai.hanzo.cloud.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws ai.hanzo.cloud.ApiException If fails to update the parameters
     */
     ...
     * @throws ai.hanzo.cloud.ApiException If fail to serialize the request body object into a string
     */
