...
public class DatasetList {
  ...
  private List<DatasetView> data = new ArrayList<>();

  public DatasetList() {
  }

  public DatasetList data(@javax.annotation.Nullable List<DatasetView> data) {
    this.data = data;
    return this;
  }

  public DatasetList addDataItem(DatasetView dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<DatasetView> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<DatasetView> data) {
    this.data = data;
  }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            DatasetView.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
