...
public class History {
  ...
  public History at(@javax.annotation.Nullable String at) {
    this.at = at;
    return this;
  }
  ...
  public History chain(@javax.annotation.Nullable String chain) {
    this.chain = chain;
    return this;
  }
  ...
  public History days(@javax.annotation.Nullable List<Day> days) {
    this.days = days;
    return this;
  }

  public History addDaysItem(Day daysItem) {
    if (this.days == null) {
  ...
  public void setDays(@javax.annotation.Nullable List<Day> days) {
    this.days = days;
  }


  public History reach(@javax.annotation.Nullable Reach reach) {
    this.reach = reach;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.at, history.at) &&
        Objects.equals(this.chain, history.chain) &&
        Objects.equals(this.days, history.days) &&
        Objects.equals(this.reach, history.reach);
  }

  @Override
  public int hashCode() {
    return Objects.hash(at, chain, days, reach);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("at", "chain", "days", "reach"));
      ...
      if (jsonObj.get("days") != null && !jsonObj.get("days").isJsonNull()) {
        ...
        if (jsonArraydays != null) {
          ...
          for (int i = 0; i < jsonArraydays.size(); i++) {
            Day.validateJsonElement(jsonArraydays.get(i));
          };
        }
      }
