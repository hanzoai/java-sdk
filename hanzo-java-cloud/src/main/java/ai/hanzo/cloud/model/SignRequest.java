...
public class SignRequest {
  ...
  @javax.annotation.Nullable
  private List<LegalSigner> signers = new ArrayList<>();

  public SignRequest() {
  }

  public SignRequest id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public SignRequest signers(@javax.annotation.Nullable List<LegalSigner> signers) {
    this.signers = signers;
    return this;
  }

  public SignRequest addSignersItem(LegalSigner signersItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<LegalSigner> getSigners() {
    return signers;
  }

  public void setSigners(@javax.annotation.Nullable List<LegalSigner> signers) {
    this.signers = signers;
  }
      ...
      if (jsonObj.get("signers") != null && !jsonObj.get("signers").isJsonNull()) {
        ...
        if (jsonArraysigners != null) {
          ...
          for (int i = 0; i < jsonArraysigners.size(); i++) {
            LegalSigner.validateJsonElement(jsonArraysigners.get(i));
          };
        }
      }
  }
