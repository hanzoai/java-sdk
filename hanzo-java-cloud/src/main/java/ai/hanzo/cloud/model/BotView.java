...
public class BotView {
  ...
  public BotView agent(@javax.annotation.Nullable String agent) {
    this.agent = agent;
    return this;
  }
  ...
  public BotView binding(@javax.annotation.Nullable AgentBinding binding) {
  ...
  public BotView createdTime(@javax.annotation.Nullable String createdTime) {
  ...
  public BotView gpu(@javax.annotation.Nullable String gpu) {
    this.gpu = gpu;
    return this;
  }
  ...
  public BotView id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public BotView image(@javax.annotation.Nullable String image) {
    this.image = image;
    return this;
  }
  ...
  public BotView mem(@javax.annotation.Nullable String mem) {
    this.mem = mem;
    return this;
  }
  ...
  public BotView name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public BotView os(@javax.annotation.Nullable String os) {
    this.os = os;
    return this;
  }
  ...
  public BotView privateIp(@javax.annotation.Nullable String privateIp) {
  ...
  public BotView provider(@javax.annotation.Nullable String provider) {
  ...
  public BotView publicIp(@javax.annotation.Nullable String publicIp) {
  ...
  public BotView region(@javax.annotation.Nullable String region) {
    this.region = region;
    return this;
  }
  ...
  public BotView status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public BotView type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.agent, botView.agent) &&
        Objects.equals(this.binding, botView.binding) &&
        Objects.equals(this.createdTime, botView.createdTime) &&
        Objects.equals(this.gpu, botView.gpu) &&
        Objects.equals(this.id, botView.id) &&
        Objects.equals(this.image, botView.image) &&
        Objects.equals(this.mem, botView.mem) &&
        Objects.equals(this.name, botView.name) &&
        Objects.equals(this.os, botView.os) &&
        Objects.equals(this.privateIp, botView.privateIp) &&
        Objects.equals(this.provider, botView.provider) &&
        Objects.equals(this.publicIp, botView.publicIp) &&
        Objects.equals(this.region, botView.region) &&
        Objects.equals(this.status, botView.status) &&
        Objects.equals(this.type, botView.type) &&
        Objects.equals(this.vcpu, botView.vcpu);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BotView
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BotView.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BotView is not found in the empty JSON string", BotView.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BotView.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BotView` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BotView.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BotView' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BotView> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BotView.class));

       return (TypeAdapter<T>) new TypeAdapter<BotView>() {
           @Override
           public void write(JsonWriter out, BotView value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BotView read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BotView given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BotView
   * @throws IOException if the JSON string is invalid with respect to BotView
   */
  public static BotView fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BotView.class);
  }

  /**
   * Convert an instance of BotView to an JSON string
   *
   * @return JSON string
   */
