...
public class Form {
  ...
  public Form code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public Form signed(@javax.annotation.Nullable Boolean signed) {
    this.signed = signed;
    return this;
  }
  ...
  public Form why(@javax.annotation.Nullable String why) {
    this.why = why;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Form form = (Form) o;
    return Objects.equals(this.code, form.code) &&
        Objects.equals(this.name, form.name) &&
        Objects.equals(this.signed, form.signed) &&
        Objects.equals(this.why, form.why);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, name, signed, why);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("code", "name", "signed", "why"));
