...
public class ItemList {
  ...
  private List<ItemView> data = new ArrayList<>();

  public ItemList() {
  }

  public ItemList data(@javax.annotation.Nullable List<ItemView> data) {
    this.data = data;
    return this;
  }

  public ItemList addDataItem(ItemView dataItem) {
    if (this.data == null) {
  ...
  public void setData(@javax.annotation.Nullable List<ItemView> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, itemList.data);
  }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ItemView.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
