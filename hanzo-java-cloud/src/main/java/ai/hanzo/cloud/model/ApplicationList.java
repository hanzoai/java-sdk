...
public class ApplicationList {
  ...
  private List<ProgramApplication> data = new ArrayList<>();

  public ApplicationList() {
  }

  public ApplicationList data(@javax.annotation.Nullable List<ProgramApplication> data) {
    this.data = data;
    return this;
  }

  public ApplicationList addDataItem(ProgramApplication dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ProgramApplication> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<ProgramApplication> data) {
    this.data = data;
  }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ProgramApplication.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
