...
public class ContactList {
  ...
  public ContactList data(@javax.annotation.Nullable List<Contact> data) {
    this.data = data;
    return this;
  }

  public ContactList addDataItem(Contact dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, contactList.data);
  }
