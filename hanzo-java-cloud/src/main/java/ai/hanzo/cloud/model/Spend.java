...
public class Spend {
  ...
  @javax.annotation.Nullable
  private List<CategorySpend> byCategory = new ArrayList<>();
  ...
  @javax.annotation.Nullable
  private List<SpendPoint> series = new ArrayList<>();
  ...
  public Spend available(@javax.annotation.Nullable Boolean available) {
  ...
  public Spend byCategory(@javax.annotation.Nullable List<CategorySpend> byCategory) {
    this.byCategory = byCategory;
    return this;
  }

  public Spend addByCategoryItem(CategorySpend byCategoryItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<CategorySpend> getByCategory() {
    return byCategory;
  }

  public void setByCategory(@javax.annotation.Nullable List<CategorySpend> byCategory) {
    this.byCategory = byCategory;
  }
  ...
  public Spend series(@javax.annotation.Nullable List<SpendPoint> series) {
    this.series = series;
    return this;
  }

  public Spend addSeriesItem(SpendPoint seriesItem) {
    if (this.series == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<SpendPoint> getSeries() {
    return series;
  }

  public void setSeries(@javax.annotation.Nullable List<SpendPoint> series) {
    this.series = series;
  }


  public Spend source(@javax.annotation.Nullable String source) {
    this.source = source;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Spend spend = (Spend) o;
    return Objects.equals(this.available, spend.available) &&
        Objects.equals(this.availableCents, spend.availableCents) &&
        Objects.equals(this.balanceCents, spend.balanceCents) &&
        Objects.equals(this.byCategory, spend.byCategory) &&
        Objects.equals(this.mtdCents, spend.mtdCents) &&
        Objects.equals(this.overageCents, spend.overageCents) &&
        Objects.equals(this.series, spend.series) &&
        Objects.equals(this.source, spend.source) &&
        Objects.equals(this.totalCents, spend.totalCents);
  }
      ...
      if (jsonObj.get("byCategory") != null && !jsonObj.get("byCategory").isJsonNull()) {
        ...
        if (jsonArraybyCategory != null) {
          ...
          for (int i = 0; i < jsonArraybyCategory.size(); i++) {
            CategorySpend.validateJsonElement(jsonArraybyCategory.get(i));
          };
        }
      }
      if (jsonObj.get("series") != null && !jsonObj.get("series").isJsonNull()) {
        ...
        if (jsonArrayseries != null) {
          ...
          for (int i = 0; i < jsonArrayseries.size(); i++) {
            SpendPoint.validateJsonElement(jsonArrayseries.get(i));
          };
        }
      }
