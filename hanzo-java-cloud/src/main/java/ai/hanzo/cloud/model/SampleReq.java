...
public class SampleReq {
  ...
  public SampleReq account(@javax.annotation.Nullable String account) {
  ...
  public SampleReq cachedInputTokens(@javax.annotation.Nullable Integer cachedInputTokens) {
  ...
  public SampleReq confidence(@javax.annotation.Nullable String confidence) {
  ...
  public SampleReq costCents(@javax.annotation.Nullable Integer costCents) {
  ...
  public SampleReq costLimitCents(@javax.annotation.Nullable Integer costLimitCents) {
  ...
  public SampleReq currency(@javax.annotation.Nullable String currency) {
  ...
  public SampleReq inputTokens(@javax.annotation.Nullable Integer inputTokens) {
  ...
  public SampleReq kind(@javax.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public SampleReq lane(@javax.annotation.Nullable String lane) {
    this.lane = lane;
    return this;
  }
  ...
  public SampleReq machine(@javax.annotation.Nullable String machine) {
  ...
  public SampleReq outputTokens(@javax.annotation.Nullable Integer outputTokens) {
  ...
  public SampleReq plan(@javax.annotation.Nullable String plan) {
    this.plan = plan;
    return this;
  }
  ...
  public SampleReq provider(@javax.annotation.Nullable String provider) {
  ...
  public SampleReq requests(@javax.annotation.Nullable Integer requests) {
  ...
  public SampleReq resetsAt(@javax.annotation.Nullable String resetsAt) {
  ...
  public SampleReq synthetic(@javax.annotation.Nullable Boolean synthetic) {
  ...
  public SampleReq totalTokens(@javax.annotation.Nullable Integer totalTokens) {
  ...
  public SampleReq usedPct(@javax.annotation.Nullable BigDecimal usedPct) {
  ...
  public SampleReq window(@javax.annotation.Nullable String window) {
    this.window = window;
    return this;
  }
  ...
  public SampleReq windowMinutes(@javax.annotation.Nullable Integer windowMinutes) {
  ...
  public SampleReq windowStart(@javax.annotation.Nullable String windowStart) {
  ...
  public boolean equals(Object o) {
    ...
    SampleReq sampleReq = (SampleReq) o;
    return Objects.equals(this.account, sampleReq.account) &&
        Objects.equals(this.cachedInputTokens, sampleReq.cachedInputTokens) &&
        Objects.equals(this.confidence, sampleReq.confidence) &&
        Objects.equals(this.costCents, sampleReq.costCents) &&
        Objects.equals(this.costLimitCents, sampleReq.costLimitCents) &&
        Objects.equals(this.currency, sampleReq.currency) &&
        Objects.equals(this.inputTokens, sampleReq.inputTokens) &&
        Objects.equals(this.kind, sampleReq.kind) &&
        Objects.equals(this.lane, sampleReq.lane) &&
        Objects.equals(this.machine, sampleReq.machine) &&
        Objects.equals(this.outputTokens, sampleReq.outputTokens) &&
        Objects.equals(this.plan, sampleReq.plan) &&
        Objects.equals(this.provider, sampleReq.provider) &&
        Objects.equals(this.requests, sampleReq.requests) &&
        Objects.equals(this.resetsAt, sampleReq.resetsAt) &&
        Objects.equals(this.synthetic, sampleReq.synthetic) &&
        Objects.equals(this.totalTokens, sampleReq.totalTokens) &&
        Objects.equals(this.usedPct, sampleReq.usedPct) &&
        Objects.equals(this.window, sampleReq.window) &&
        Objects.equals(this.windowMinutes, sampleReq.windowMinutes) &&
        Objects.equals(this.windowStart, sampleReq.windowStart);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SampleReq
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SampleReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SampleReq is not found in the empty JSON string", SampleReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SampleReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SampleReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SampleReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SampleReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SampleReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SampleReq.class));

       return (TypeAdapter<T>) new TypeAdapter<SampleReq>() {
           @Override
           public void write(JsonWriter out, SampleReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SampleReq read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SampleReq given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SampleReq
   * @throws IOException if the JSON string is invalid with respect to SampleReq
   */
  public static SampleReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SampleReq.class);
  }

  /**
   * Convert an instance of SampleReq to an JSON string
   *
   * @return JSON string
   */
