...
public class CloudEntry {
  ...
  public CloudEntry archetype(@javax.annotation.Nullable String archetype) {
  ...
  public CloudEntry description(@javax.annotation.Nullable String description) {
  ...
  public CloudEntry forkable(@javax.annotation.Nullable Boolean forkable) {
  ...
  public CloudEntry id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CloudEntry kind(@javax.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public CloudEntry language(@javax.annotation.Nullable String language) {
  ...
  public CloudEntry license(@javax.annotation.Nullable String license) {
  ...
  public CloudEntry name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public CloudEntry note(@javax.annotation.Nullable String note) {
    this.note = note;
    return this;
  }
  ...
  public CloudEntry org(@javax.annotation.Nullable String org) {
    this.org = org;
    return this;
  }
  ...
  public CloudEntry origin(@javax.annotation.Nullable String origin) {
    this.origin = origin;
    return this;
  }
  ...
  public CloudEntry repo(@javax.annotation.Nullable String repo) {
    this.repo = repo;
    return this;
  }
  ...
  public CloudEntry scope(@javax.annotation.Nullable String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public CloudEntry stars(@javax.annotation.Nullable Integer stars) {
    this.stars = stars;
    return this;
  }
  ...
  public CloudEntry template(@javax.annotation.Nullable String template) {
  ...
  public CloudEntry title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public CloudEntry updated(@javax.annotation.Nullable String updated) {
  ...
  public CloudEntry upstream(@javax.annotation.Nullable String upstream) {
  ...
  public CloudEntry url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CloudEntry cloudEntry = (CloudEntry) o;
    return Objects.equals(this.archetype, cloudEntry.archetype) &&
        Objects.equals(this.description, cloudEntry.description) &&
        Objects.equals(this.forkable, cloudEntry.forkable) &&
        Objects.equals(this.id, cloudEntry.id) &&
        Objects.equals(this.kind, cloudEntry.kind) &&
        Objects.equals(this.language, cloudEntry.language) &&
        Objects.equals(this.license, cloudEntry.license) &&
        Objects.equals(this.name, cloudEntry.name) &&
        Objects.equals(this.note, cloudEntry.note) &&
        Objects.equals(this.org, cloudEntry.org) &&
        Objects.equals(this.origin, cloudEntry.origin) &&
        Objects.equals(this.repo, cloudEntry.repo) &&
        Objects.equals(this.scope, cloudEntry.scope) &&
        Objects.equals(this.stars, cloudEntry.stars) &&
        Objects.equals(this.template, cloudEntry.template) &&
        Objects.equals(this.title, cloudEntry.title) &&
        Objects.equals(this.updated, cloudEntry.updated) &&
        Objects.equals(this.upstream, cloudEntry.upstream) &&
        Objects.equals(this.url, cloudEntry.url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloudEntry
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloudEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloudEntry is not found in the empty JSON string", CloudEntry.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudEntry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CloudEntry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloudEntry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloudEntry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloudEntry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloudEntry.class));

       return (TypeAdapter<T>) new TypeAdapter<CloudEntry>() {
           @Override
           public void write(JsonWriter out, CloudEntry value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CloudEntry read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CloudEntry given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CloudEntry
   * @throws IOException if the JSON string is invalid with respect to CloudEntry
   */
  public static CloudEntry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloudEntry.class);
  }

  /**
   * Convert an instance of CloudEntry to an JSON string
   *
   * @return JSON string
   */
