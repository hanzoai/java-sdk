...
public class AiResponse {
  ...
  public AiResponse code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public AiResponse data(@javax.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public AiResponse data2(@javax.annotation.Nullable Object data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public AiResponse msg(@javax.annotation.Nullable String msg) {
    this.msg = msg;
    return this;
  }
  ...
  public AiResponse status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, aiResponse.code) &&
        Objects.equals(this.data, aiResponse.data) &&
        Objects.equals(this.data2, aiResponse.data2) &&
        Objects.equals(this.msg, aiResponse.msg) &&
        Objects.equals(this.status, aiResponse.status);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, data, data2, msg, status);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("code", "data", "data2", "msg", "status"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AiResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AiResponse is not found in the empty JSON string", AiResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AiResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AiResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
