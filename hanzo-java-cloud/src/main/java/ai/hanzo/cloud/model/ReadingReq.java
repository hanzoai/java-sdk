...
public class ReadingReq {
  ...
  public ReadingReq account(@javax.annotation.Nullable String account) {
  ...
  public ReadingReq cachedInputTokens(@javax.annotation.Nullable Integer cachedInputTokens) {
  ...
  public ReadingReq confidence(@javax.annotation.Nullable String confidence) {
  ...
  public ReadingReq costCents(@javax.annotation.Nullable Integer costCents) {
  ...
  public ReadingReq costLimitCents(@javax.annotation.Nullable Integer costLimitCents) {
  ...
  public ReadingReq currency(@javax.annotation.Nullable String currency) {
  ...
  public ReadingReq inputTokens(@javax.annotation.Nullable Integer inputTokens) {
  ...
  public ReadingReq kind(@javax.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public ReadingReq lane(@javax.annotation.Nullable String lane) {
    this.lane = lane;
    return this;
  }
  ...
  public ReadingReq machine(@javax.annotation.Nullable String machine) {
  ...
  public ReadingReq outputTokens(@javax.annotation.Nullable Integer outputTokens) {
  ...
  public ReadingReq plan(@javax.annotation.Nullable String plan) {
    this.plan = plan;
    return this;
  }
  ...
  public ReadingReq provider(@javax.annotation.Nullable String provider) {
  ...
  public ReadingReq requests(@javax.annotation.Nullable Integer requests) {
  ...
  public ReadingReq resetsAt(@javax.annotation.Nullable String resetsAt) {
  ...
  public ReadingReq synthetic(@javax.annotation.Nullable Boolean synthetic) {
  ...
  public ReadingReq totalTokens(@javax.annotation.Nullable Integer totalTokens) {
  ...
  public ReadingReq usedPct(@javax.annotation.Nullable BigDecimal usedPct) {
  ...
  public ReadingReq window(@javax.annotation.Nullable String window) {
    this.window = window;
    return this;
  }
  ...
  public ReadingReq windowMinutes(@javax.annotation.Nullable Integer windowMinutes) {
  ...
  public ReadingReq windowStart(@javax.annotation.Nullable String windowStart) {
  ...
  public boolean equals(Object o) {
    ...
    ReadingReq readingReq = (ReadingReq) o;
    return Objects.equals(this.account, readingReq.account) &&
        Objects.equals(this.cachedInputTokens, readingReq.cachedInputTokens) &&
        Objects.equals(this.confidence, readingReq.confidence) &&
        Objects.equals(this.costCents, readingReq.costCents) &&
        Objects.equals(this.costLimitCents, readingReq.costLimitCents) &&
        Objects.equals(this.currency, readingReq.currency) &&
        Objects.equals(this.inputTokens, readingReq.inputTokens) &&
        Objects.equals(this.kind, readingReq.kind) &&
        Objects.equals(this.lane, readingReq.lane) &&
        Objects.equals(this.machine, readingReq.machine) &&
        Objects.equals(this.outputTokens, readingReq.outputTokens) &&
        Objects.equals(this.plan, readingReq.plan) &&
        Objects.equals(this.provider, readingReq.provider) &&
        Objects.equals(this.requests, readingReq.requests) &&
        Objects.equals(this.resetsAt, readingReq.resetsAt) &&
        Objects.equals(this.synthetic, readingReq.synthetic) &&
        Objects.equals(this.totalTokens, readingReq.totalTokens) &&
        Objects.equals(this.usedPct, readingReq.usedPct) &&
        Objects.equals(this.window, readingReq.window) &&
        Objects.equals(this.windowMinutes, readingReq.windowMinutes) &&
        Objects.equals(this.windowStart, readingReq.windowStart);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReadingReq
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReadingReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReadingReq is not found in the empty JSON string", ReadingReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReadingReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReadingReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReadingReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReadingReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReadingReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReadingReq.class));

       return (TypeAdapter<T>) new TypeAdapter<ReadingReq>() {
           @Override
           public void write(JsonWriter out, ReadingReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReadingReq read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReadingReq given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReadingReq
   * @throws IOException if the JSON string is invalid with respect to ReadingReq
   */
  public static ReadingReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReadingReq.class);
  }

  /**
   * Convert an instance of ReadingReq to an JSON string
   *
   * @return JSON string
   */
