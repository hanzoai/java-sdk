...
public class ChannelList {
  ...
  public ChannelList data(@javax.annotation.Nullable List<Channel> data) {
    this.data = data;
    return this;
  }

  public ChannelList addDataItem(Channel dataItem) {
    if (this.data == null) {
  ...
  public void setData(@javax.annotation.Nullable List<Channel> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, channelList.data);
  }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Channel.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
