...
public class UsageWindowView {
  ...
  public UsageWindowView cachedInputTokens(@javax.annotation.Nullable Integer cachedInputTokens) {
  ...
  public UsageWindowView costCents(@javax.annotation.Nullable Integer costCents) {
  ...
  public UsageWindowView costLimitCents(@javax.annotation.Nullable Integer costLimitCents) {
  ...
  public UsageWindowView inputTokens(@javax.annotation.Nullable Integer inputTokens) {
  ...
  public UsageWindowView outputTokens(@javax.annotation.Nullable Integer outputTokens) {
  ...
  public UsageWindowView requests(@javax.annotation.Nullable Integer requests) {
  ...
  public UsageWindowView totalTokens(@javax.annotation.Nullable Integer totalTokens) {
  ...
  public UsageWindowView usedPct(@javax.annotation.Nullable BigDecimal usedPct) {
