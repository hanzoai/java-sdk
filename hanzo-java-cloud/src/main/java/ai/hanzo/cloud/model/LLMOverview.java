...
public class LLMOverview {
  ...
  public LLMOverview available(@javax.annotation.Nullable Boolean available) {
  ...
  public LLMOverview source(@javax.annotation.Nullable String source) {
    this.source = source;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LLMOverview llMOverview = (LLMOverview) o;
    return Objects.equals(this.available, llMOverview.available) &&
        Objects.equals(this.completionTokens, llMOverview.completionTokens) &&
        Objects.equals(this.errorRate, llMOverview.errorRate) &&
        Objects.equals(this.errors, llMOverview.errors) &&
        Objects.equals(this.models, llMOverview.models) &&
        Objects.equals(this.promptTokens, llMOverview.promptTokens) &&
        Objects.equals(this.providers, llMOverview.providers) &&
        Objects.equals(this.requests, llMOverview.requests) &&
        Objects.equals(this.source, llMOverview.source) &&
        Objects.equals(this.spendCents, llMOverview.spendCents) &&
        Objects.equals(this.tokens, llMOverview.tokens);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LLMOverview
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LLMOverview.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LLMOverview is not found in the empty JSON string", LLMOverview.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LLMOverview.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LLMOverview` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LLMOverview.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LLMOverview' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LLMOverview> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LLMOverview.class));

       return (TypeAdapter<T>) new TypeAdapter<LLMOverview>() {
           @Override
           public void write(JsonWriter out, LLMOverview value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LLMOverview read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LLMOverview given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LLMOverview
   * @throws IOException if the JSON string is invalid with respect to LLMOverview
   */
  public static LLMOverview fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LLMOverview.class);
  }

  /**
   * Convert an instance of LLMOverview to an JSON string
   *
   * @return JSON string
   */
