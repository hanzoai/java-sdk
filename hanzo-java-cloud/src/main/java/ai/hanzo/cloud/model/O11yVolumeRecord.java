...
public class O11yVolumeRecord {
  ...
  public O11yVolumeRecord meta(@javax.annotation.Nullable Map<String, String> meta) {
    this.meta = meta;
    return this;
  }

  public O11yVolumeRecord putMetaItem(String key, String metaItem) {
    if (this.meta == null) {
  ...
  public O11yVolumeRecord persistentVolumeClaimName(@javax.annotation.Nullable String persistentVolumeClaimName) {
  ...
  public boolean equals(Object o) {
    ...
    O11yVolumeRecord o11yVolumeRecord = (O11yVolumeRecord) o;
    return Objects.equals(this.meta, o11yVolumeRecord.meta) &&
        Objects.equals(this.persistentVolumeClaimName, o11yVolumeRecord.persistentVolumeClaimName) &&
        Objects.equals(this.volumeAvailable, o11yVolumeRecord.volumeAvailable) &&
        Objects.equals(this.volumeCapacity, o11yVolumeRecord.volumeCapacity) &&
        Objects.equals(this.volumeInodes, o11yVolumeRecord.volumeInodes) &&
        Objects.equals(this.volumeInodesFree, o11yVolumeRecord.volumeInodesFree) &&
        Objects.equals(this.volumeInodesUsed, o11yVolumeRecord.volumeInodesUsed) &&
        Objects.equals(this.volumeUsage, o11yVolumeRecord.volumeUsage);
  }
  ...
  public String toString() {
    ...
    sb.append("class O11yVolumeRecord {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to O11yVolumeRecord
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!O11yVolumeRecord.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in O11yVolumeRecord is not found in the empty JSON string", O11yVolumeRecord.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!O11yVolumeRecord.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `O11yVolumeRecord` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!O11yVolumeRecord.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'O11yVolumeRecord' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<O11yVolumeRecord> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(O11yVolumeRecord.class));

       return (TypeAdapter<T>) new TypeAdapter<O11yVolumeRecord>() {
           @Override
           public void write(JsonWriter out, O11yVolumeRecord value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public O11yVolumeRecord read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of O11yVolumeRecord given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of O11yVolumeRecord
   * @throws IOException if the JSON string is invalid with respect to O11yVolumeRecord
   */
  public static O11yVolumeRecord fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, O11yVolumeRecord.class);
  }

  /**
   * Convert an instance of O11yVolumeRecord to an JSON string
   *
   * @return JSON string
   */
