...
public class GenerateTextToSpeechAudioApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public GenerateTextToSpeechAudioApi() {
        this(Configuration.getDefaultApiClient());
    }

    public GenerateTextToSpeechAudioApi(ApiClient apiClient) {
    ...
    public okhttp3.Call postGenerateTextToSpeechAudioCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/generate-text-to-speech-audio";
