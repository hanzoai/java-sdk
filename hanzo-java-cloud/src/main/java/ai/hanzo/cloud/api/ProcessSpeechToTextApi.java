...
public class ProcessSpeechToTextApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ProcessSpeechToTextApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ProcessSpeechToTextApi(ApiClient apiClient) {
    ...
    public okhttp3.Call postProcessSpeechToTextCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/process-speech-to-text";
