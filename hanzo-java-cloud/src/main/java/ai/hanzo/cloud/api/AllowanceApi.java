...
public class AllowanceApi {
    ...
    public AllowanceApi(ApiClient apiClient) {
    ...
    public okhttp3.Call getAllowanceCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/allowance";
    ...
    private okhttp3.Call getAllowanceValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getAllowanceCall(_callback);
