...
public class AuthorApi {
    ...
    private okhttp3.Call getAuthorValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getAuthorCall(_callback);
    ...
    public Map<String, Object> getAuthor() throws ApiException {
        ApiResponse<Map<String, Object>> localVarResp = getAuthorWithHttpInfo();
    ...
    public ApiResponse<Map<String, Object>> getAuthorWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getAuthorValidateBeforeCall(null);
    ...
    public okhttp3.Call getAuthorAsync(final ApiCallback<Map<String, Object>> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAuthorValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<Map<String, Object>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getAuthorBasis
    ...
    public okhttp3.Call getAuthorBasisCall(@javax.annotation.Nullable String period, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v1/author/basis";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAuthorBasisValidateBeforeCall(@javax.annotation.Nullable String period, final ApiCallback _callback) throws ApiException {
        return getAuthorBasisCall(period, _callback);
    ...
    public Map<String, Object> getAuthorBasis(@javax.annotation.Nullable String period) throws ApiException {
        ApiResponse<Map<String, Object>> localVarResp = getAuthorBasisWithHttpInfo(period);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<Map<String, Object>> getAuthorBasisWithHttpInfo(@javax.annotation.Nullable String period) throws ApiException {
        okhttp3.Call localVarCall = getAuthorBasisValidateBeforeCall(period, null);
        Type localVarReturnType = new TypeToken<Map<String, Object>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call getAuthorBasisAsync(@javax.annotation.Nullable String period, final ApiCallback<Map<String, Object>> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAuthorBasisValidateBeforeCall(period, _callback);
        Type localVarReturnType = new TypeToken<Map<String, Object>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
