...
public class ValidatorApi {
    ...
    private okhttp3.Call getValidatorValidateBeforeCall(@javax.annotation.Nullable String limit, final ApiCallback _callback) throws ApiException {
        return getValidatorCall(limit, _callback);
    ...
    /**
     * Build call for getValidatorByTokenid
    ...
    public okhttp3.Call getValidatorByTokenidCall(@javax.annotation.Nonnull String tokenId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v1/validator/{tokenId}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getValidatorByTokenidValidateBeforeCall(@javax.annotation.Nonnull String tokenId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'tokenId' is set
        if (tokenId == null) {
            throw new ApiException("Missing the required parameter 'tokenId' when calling getValidatorByTokenid(Async)");
        }

        return getValidatorByTokenidCall(tokenId, _callback);
    ...
    /**
     * Build call for getValidatorChallenge
    ...
    public okhttp3.Call getValidatorChallengeCall(@javax.annotation.Nullable String tokenId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v1/validator/challenge";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getValidatorChallengeValidateBeforeCall(@javax.annotation.Nullable String tokenId, final ApiCallback _callback) throws ApiException {
        return getValidatorChallengeCall(tokenId, _callback);
