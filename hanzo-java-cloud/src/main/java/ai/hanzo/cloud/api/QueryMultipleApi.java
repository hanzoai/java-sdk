...
public class QueryMultipleApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public QueryMultipleApi() {
        this(Configuration.getDefaultApiClient());
    }

    public QueryMultipleApi(ApiClient apiClient) {
    ...
    public okhttp3.Call postV1QueryMultipleCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/query_multiple";
    ...
    /**
     * Handles POST /v1/query_multiple — {file_ids,query,k}. (asynchronously)
     * Handles POST /v1/query_multiple — {file_ids,query,k}.
